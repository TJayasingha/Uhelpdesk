...
# def queue_member_add(request, queue_id):
#     queue = get_object_or_404(Queue, id=queue_id)
    ...
    #     if form.is_valid():
    #         form.save()
    #         all_items Queue.objects.all()
    #         messages.success(request,('member has been added'))
    #         return render(request, 'queue_member_add.html',{'all_items':all_items})
    # else:
    #     form_queues = QueueMemberForm()
    #     form_user = TicketCCUserForm()
    #     all_items Queue.objects.all()
    # return render(request, 'helpdesk/queue_member_add.html', {'all_items':all_items})


# queue_member_add = staff_member_required(queue_member_add)